...
![plots of vernier fits.](tools/vernierFitPlot.png)

``` r
plotpar(fit) #plot the parameters
```

![params of vernier fits](tools/vernierParamsPlot.png)

``` r
plotthresholds(fit)
```

![thresholds of vernier fits](tools/vernierThreshesPlot.png)
